...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-wide mx-auto px-4 lg:px-8 py-32">
        <motion.div
        ...
        >
          <motion.span
            ...
            className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest bg-primary-foreground/15 text-primary-foreground border border-primary-foreground/20 mb-6"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link to="/products" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-primary-foreground border-2 border-primary-foreground/30 hover:bg-primary-foreground/10 transition-all text-base">
              Explore Plants
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-background/95 backdrop-blur-md border-t border-border">
        <div className="container-wide mx-auto px-4 lg:px-8 py-5">
